...
$classes = Flux::classes()
    ->add('py-3 px-1 first:ps-3 last:pe-3')
    ->add('text-start text-sm font-medium text-zinc-800 bg-zinc-100 dark:text-white dark:bg-zinc-800/10')
    ->add('border-b border-zinc-800/10 dark:border-white/20 first:rounded-tl-xl last:rounded-tr-xl')
    ->add(match($align) {
