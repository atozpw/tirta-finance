    ...
    */
    ...
    'connections' => [
        ...
        'mariadb-transaction' => [
            ...
            'port' => env('DB_TRANSACTION_PORT', '3306'),
            'database' => env('DB_TRANSACTION_DATABASE', 'laravel'),
            'username' => env('DB_TRANSACTION_USERNAME', 'root'),
            'password' => env('DB_TRANSACTION_PASSWORD', ''),
            'unix_socket' => env('DB_TRANSACTION_SOCKET', ''),
            'charset' => env('DB_TRANSACTION_CHARSET', 'utf8mb4'),
            'collation' => env('DB_TRANSACTION_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
